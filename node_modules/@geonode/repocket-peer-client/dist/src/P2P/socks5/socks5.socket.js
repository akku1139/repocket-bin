...
exports.Socket5Handler = void 0;
const promises_1 = require("dns/promises");
const net_1 = __importDefault(require("net"));
const ipv6_1 = __importDefault(require("./utils/ipv6"));
class Socket5Handler {
    ...
    reply(rep, address = null) {
        ...
        if (address.family === 'IPv4') {
            ...
            data.push(0x04);
            const ipv6BufArr = ipv6_1.default.toBufArr(address.address);
    ...
    async request(data) {
        ...
        if (data[1] == 0x01) {
            ...
            // @ts-ignore
            if (data[2] !== 0x00)
                this.logger.warn('RESERVED should be 0x00');
            let dstHost, dstPort;
            // @ts-ignore
            switch (data[3]) {
                case 0x01: // ipv4
                ...
                case 0x03: {
                    ...
                    try {
                        const dnsResolver = new promises_1.Resolver();
                ...
                case 0x04: {
                    ...
                    dstHost = ipv6_1.default.toStr(addrBuf);
    ...
    createConnection(dstHost, dstPort, retries = 3) {
        if (retries <= 0) {
            this.logger.error('Connection retries exceeded', dstHost, dstPort, retries);
            this.reply(0x05);
            return this.socket.end();
        }
        let replyed = false;
        const proxy = net_1.default.createConnection({
            host: dstHost,
            port: dstPort,
...
exports.Socket5Handler = Socket5Handler;
