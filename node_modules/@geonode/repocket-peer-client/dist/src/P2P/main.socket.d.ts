...
export declare class MainSocket {
    ...
    initRequestHandlerStandBySockets(n: any): void;
    initRequestHandlerStandByWaitingMode(): RequestHandlerSocket;
    initRequestSocketHandler(reqId: any, standByMode?: boolean): void;
