...
class TargetSocket {
    ...
    connect() {
        ...
        if (this.isHttps()) {
            ...
            (0, helpers_1.writeToSocket)(this.requestHandlerSocket, `${this.request['httpVersion']} 200 Connection Established\r\n\r\n`);
        ...
        if (!this.isHttps()) {
            try {
                (0, helpers_1.writeToSocket)(this.socket, this.buffer);
    ...
    onSocketCloseEvent() {
        this.emitter.emit(P2P_service_1.P2PEvents.onTargetSocketEnd);
    }
