...
const prod = {
  env: 'production',
  apiUrl: 'https://api.repocket.com/api',
  peerApiUrl: 'https://peer.repocket.com/api',
  monitorApiUrl: 'https://monitor.repocket.com/api',
  baseUrl: 'https://app.repocket.com',
...
const config = getConfig(process.env.NODE_ENV as string); // TODO : CHAGE TO DEV
